...
{"title":"Jinhui Shipping i minus i fjerde kvartal","lead":"Tørrlastrederiet Jinhui Shipping snudde til et underskudd før skatt på 2,7 millioner dollar i fjorårets fjerde kvartal, fra et overskudd på 5,2 millioner året før. Styret foreslår samtidig et utbytte på 0,18 dollar per aksje for 2025.","body":["• Omsetning på 37,5 millioner dollar, ned fra 44,2 millioner i samme kvartal året før","• Engangstap på tre millioner dollar knyttet til salg av tre Supramax-skip","Totalt kvittet selskapet seg med åtte slike skip i fjor, noe som har dempet inntektene.","Ved nyttår drev selskapet 23 fartøy, 18 av dem var selveide. Selskapet har seks Ultramax-skip under bygging som skal leveres i 2028 og 2029."],"company_sentence":"Jinhui Shipping er et shippingselskap som frakter tørrlast.","key_facts":["Underskudd på 2,7 mill. dollar i Q4","Omsetning falt til 37,5 mill. fra 44,2 mill.","Utbytte foreslått: 0,18 dollar per aksje","Engangstap på 3 mill. dollar fra skipsalg"],"negative_or_surprising":["Gikk fra overskudd til underskudd i Q4","Foreslår utbytte til tross for underskudd"],"excluded_hype":[],"source_limitations":["Kun et utdrag av rapporten er analysert"],"confidence":"high","importance":"uviktig","source_spans":["resultat før skatt minus 2,7 mill.","omsetning 37,5 mill.","utbytte 0,18 dollar"]}
...
{"title":"Lavere inntekter for Odfjell Technology – gjør oppkjøp","lead":"Oljeleverandøren Odfjell Technology økte resultatet før skatt til 93,4 millioner kroner i fjerde kvartal, fra 78,7 millioner året før. Samtidig kjøper selskapet seg inn i to brønnserviceselskaper.","body":["• Resultat etter skatt faller til 65,7 millioner, fra 74,7 millioner i fjerde kvartal året før","• Omsetningen falt til 1,4 milliarder, fra 1,45 milliarder året før","Odfjell Technology melder også om at selskapet skal kjøpe 70 prosent av Kaseum Holding og Razor Oiltools, som driver med intervensjon og plugging av brønner. Selskapet har opsjon på de resterende 30 prosent.","De to selskapene verdsettes til 38,5 millioner pund.","Kjøpet finansieres med å tappe 600 millioner kroner fra eksisterende lån, kombinert med eksisterende midler. Gjeldsgraden vil fortsatt være moderat, ifølge selskapet."],"company_sentence":"Odfjell Technology leverer teknologi og tjenester til olje- og gassindustrien.","key_facts":["Resultat før skatt opp til 93,4 mill. fra 78,7 mill.","Omsetning ned til 1,4 mrd. fra 1,45 mrd.","Kjøper Kaseum/Razor Oiltools for 38,5 mill. pund"],"negative_or_surprising":["Svakere bunnlinje til tross for bedre resultat før skatt"],"excluded_hype":[],"source_limitations":["Kun et utdrag av rapporten er analysert"],"confidence":"high","importance":"medium","source_spans":["resultat før skatt 93,4 mill.","omsetning 1,4 mrd.","kjøpe 70 prosent av Kaseum"]}
...
{"title":"IWS vil betale utbytte for første gang","lead":"Leverandørselskapet Integrated Wind Solutions (IWS) melder om rekordhøyt resultat etter skatt og vil betale sitt første utbytte.","body":["Resultatet før skatt var 6,85 millioner euro i fjorårets fjerde kvartal, opp fra 6,5 millioner euro året før. Resultat etter skatt var 7,8 millioner euro, opp fra 5,8 millioner.","Selskapet vil betale tre kroner per aksje i utbytte, hvorav én krone er ordinært utbytte.","– Utbyttet på tre kroner per aksje er en betydelig milepæl for IWS, sier konsernsjef Lars-Henrik Røren.","Ordreboken var 152 millioner euro ved utgangen av kvartalet, opp 50,5 prosent fra kvartalet før."],"company_sentence":"Integrated Wind Solutions (IWS) driver serviceskip for havvindbransjen.","key_facts":["Resultat etter skatt: 7,8 mill. euro, opp fra 5,8 mill.","Første utbytte: 3 kroner per aksje","Ordrebok: 152 mill. euro, opp 50,5 % fra Q3"],"negative_or_surprising":[],"excluded_hype":[],"source_limitations":["Kun et utdrag av rapporten er analysert"],"confidence":"high","importance":"medium","source_spans":["CEO Lars-Henrik Røren: 'The dividend of NOK 3 per share is a significant milestone for IWS'","resultat etter skatt 7,8 mill.","ordrebok 152 mill."]}

Utbytte som vinkel trass svakere resultat (Höegh Autoliners — CEO-sitat med guillemets):
{"title":"Utbyttedryss fra Höegh Autoliners","lead":"Bilfraktrederiet hadde inntekter på 358 millioner dollar i fjorårets fjerde kvartal, en oppgang fra 352 millioner dollar på samme tid året før.","body":["Driftsresultatet (ebitda) var 145 millioner, en nedgang fra 179 millioner. Resultat før skatt gikk ned til 104 millioner fra 138 millioner.","Selskapet vil betale et utbytte på 99 millioner dollar (0,519 dollar per aksje) i mars.","Toppsjef Andreas Enger sier selskapet leverte et nytt sterkt år til tross for «komplekse og volatile driftsomgivelser»."],"company_sentence":"Höegh Autoliners er et bilfraktrederi.","key_facts":["Inntekter: 358 mill. dollar, opp fra 352 mill.","Ebitda ned til 145 mill. fra 179 mill. dollar","Utbytte: 99 mill. dollar"],"negative_or_surprising":["Ebitda og resultat falt til tross for inntektsvekst"],"excluded_hype":[],"source_limitations":["Kun et utdrag av rapporten er analysert"],"confidence":"high","importance":"medium","source_spans":["CEO Andreas Enger: delivered another strong year despite 'complex and volatile operating environments'","inntekter 358 mill.","utbytte 99 mill."]}
...
{"title":"Lavere inntekter for Kongsberg Automotive","lead":"Bildelprodusenten har lagt frem en rapport som viser at inntektene falt til 168 millioner euro i fjorårets fjerde kvartal, fra 185 millioner euro på samme tid året før.","body":["Driftsresultatet (ebitda) steg på sin side til 17 millioner euro, fra 10 millioner.","Resultatet før skatt snudde til pluss 5 millioner euro, fra minus 6 millioner.","Toppsjef Trond Fiskum sier resultatene inkluderer en positiv engangseffekt på 4,9 millioner euro etter en gjennomgang av periodiseringer ved årsslutt."],"company_sentence":"Kongsberg Automotive er en bildelprodusent.","key_facts":["Inntekter: 168 mill. euro, ned fra 185 mill.","Ebitda opp til 17 mill. fra 10 mill. euro","Resultat før skatt snudde til pluss 5 mill. fra minus 6 mill.","Engangseffekt: 4,9 mill. euro"],"negative_or_surprising":["Inntektsfall på 9 %","Engangseffekt forklarer mye av resultatforbedringen"],"excluded_hype":[],"source_limitations":["Kun et utdrag av rapporten er analysert"],"confidence":"high","importance":"uviktig","source_spans":["CEO Trond Fiskum ... positive one-off effect of EUR 4.9 million","inntekter 168 mill.","ebitda 17 mill."]}
...
- Etter nøkkeltallene skal du se etter én kort ledelseskommentar som forklarer årsak, marked, risiko, utsikter, strategi, finansiering, kontrakt, resultat eller en materiell hendelse. Hvis kommentaren kommer fra CEO, CFO eller styreleder og tilfører konkret forklaring, skal du normalt bruke ett kort sitatstrek-avsnitt eller en kildefast formulering i «...». Bruk personattribuert parafrase bare når et direkte sitat blir for langt, uklart eller unaturlig. Å droppe en konkret, forklarende ledelseskommentar som finnes i kilden, er en kvalitetsfeil — dropp bare generisk selvskryt.
...
Lead skal bære ETT hovedtall eller én hovedutvikling, med konkret tall. Ikke oppsummer flere nøkkeltall kvalitativt i lead ('høyere inntekter og positivt driftsresultat') — de andre tallene hører hjemme i body, og en slik lead gjør punktlisten til en gjentakelse.
...
- Etter nøkkeltallene: se etter årsak, utsikter, markedskommentar, risiko eller hendelser etter kvartalsslutt. Ta med én kort forklarende ledelses- eller kildekommentar hvis den gir konkret dekning. Ikke la saken bli en ren talliste.
...
STRUKTUR
${EDITORIAL_TITLE}
- body: 2-5 avsnitt som bygger videre på lead, med nøkkeltall, sammenligninger og eventuelle utsikter. Ikke gjenta tall eller utvikling som allerede står i lead — hvert avsnitt tilfører nytt. Hold det kort:
  ...
  Kulepunktene dekker tallene som IKKE står i lead. Tallet eller utviklingen fra lead skal ikke gjentas som eget kulepunkt.
